            ...
            <div class="inner-item">
                ...
                <div class="item-returns">
                    <div class="event-params">
                        ...
                        {include file="frontend/plugins/swag_profiling/details/array.tpl" array=$event.params}
                    </div>
                    <div class="returns-before">
                        <p class="returns-headline">Before-Listener-Triggered</p>
                        {include file="frontend/plugins/swag_profiling/details/array.tpl" array=$event.returns.0}
                    </div>
                    <div class="returns-after">
                        <p class="returns-headline">After-Listener-Triggered</p>
                        {include file="frontend/plugins/swag_profiling/details/array.tpl" array=$event.returns.1}
                    </div>
                </div>
