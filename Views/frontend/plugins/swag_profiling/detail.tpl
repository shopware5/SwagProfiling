    ...
    <div class="developer-content">
        ...
        <div class="inner-content">
            <div class="config active element-content">
                {include file="frontend/plugins/swag_profiling/details/config.tpl"}
            </div>

            <div class="request element-content">
                {include file="frontend/plugins/swag_profiling/details/request.tpl"}
            </div>

            <div class="session element-content">
                {include file="frontend/plugins/swag_profiling/details/session.tpl"}
            </div>

            <div class="template element-content">
                {include file="frontend/plugins/swag_profiling/details/template.tpl"}
            </div>

            <div class="events element-content">
                {include file="frontend/plugins/swag_profiling/details/events.tpl"}
            </div>

            <div class="queries element-content">
                {include file="frontend/plugins/swag_profiling/details/queries.tpl"}
            </div>

            <div class="emails element-content">
                {include file="frontend/plugins/swag_profiling/details/mail.tpl"}
            </div>

            <div class="dev-basket element-content">
                {include file="frontend/plugins/swag_profiling/details/basket.tpl"}
            </div>

            <div class="exception element-content">
                {include file="frontend/plugins/swag_profiling/details/exception.tpl"}
            </div>

            <div class="class-map element-content">
                {include file="frontend/plugins/swag_profiling/details/classmap.tpl"}
            </div>

            <div class="cache element-content">
                {include file="frontend/plugins/swag_profiling/details/cache.tpl"}
            </div>

            <div class="trace element-content">
                {include file="frontend/plugins/swag_profiling/details/trace.tpl"}
            </div>

            <div class="ajax element-content">
                {include file="frontend/plugins/swag_profiling/details/ajax.tpl"}
            </div>
